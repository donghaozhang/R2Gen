...
report_gt_list = []
diff_scores_list = []
for i in range(total_testing_num):
...
print('dirname', dirname, 'basename', json_basename)
print('json_basename_no_ext', json_basename_no_ext)
