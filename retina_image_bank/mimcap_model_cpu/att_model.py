...
class AttModel(CaptionModel):
    ...
    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, output_logsoftmax=1):
        ...
        xt = self.embed(it)
        # print('get_logprobs_state', it.type())
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}):
        ...
        # print('it type before self.get_logprobs_state', it.type())
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            # print('fc_feats, att_feats, att_masks', fc_feats.type(), att_feats.type())
        ...
        for t in range(self.max_seq_length + 1):
            ...
            if block_trigrams and t >= 3:
                ...
                mask = torch.zeros(logprobs.size(), requires_grad=False)  # cpu version batch_size x vocab_size
