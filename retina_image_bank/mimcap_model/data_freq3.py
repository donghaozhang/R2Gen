...
imname_list = []
cnt = 0
with open('test_189.csv', 'w', newline='') as csvfile:
	...
	for pair in test_retina_189:
		...
		filename = os.path.splitext(os.path.basename(impath))[0]
		load_impath = os.path.join(im_dir, filename + '.png')
		...
		report_gt_list.append(ground_truth_report)
		report_pred_list.append(reports_pred[0])
		# print(filename, ground_truth_report, reports_pred[0])
		print(cnt, load_impath)
		spamwriter.writerow([filename + '.png', ground_truth_report, reports_pred[0]])
		cnt = cnt + 1